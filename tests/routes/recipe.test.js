...
test('there are instructions for each recipe', () => {
  let data = [
    ...
    },
    {
      ...
      instruction_description: "Once boiling, add an egg (or however many you'd like as long as they are in a single layer in a bottom of the pot), straight from the refrigerator into the pot. Replace the lid and let it continue to boil for exactly six minutes."
    },
    {
      id: 3,
      recipe_name: 'Soft Boiled Eggs',
    ...
    },
    {
      ...
      recipe_name: 'Air Fryer Chicken Wings',
      instruction_number: 2,
      instruction_description: 'Mix 1 teaspoon of salt with 1 teaspoon of baking powder per pound of chicken. Toss the dried chicken wings in this mixture until evenly coated. Place the wings on a rack set over a sheet pan and refrigerate for at least one hour.'
    },
    {
      id: 6,
      recipe_name: 'Air Fryer Chicken Wings',
  ...
  let data = {
    'Soft Boiled Eggs': {
      ...
      instructions: {
        ...
        '2': "Once boiling, add an egg (or however many you'd like as long as they are in a single layer in a bottom of the pot), straight from the refrigerator into the pot. Replace the lid and let it continue to boil for exactly six minutes.",
    ...
    'Air Fryer Chicken Wings': {
      ...
      instructions: {
        ...
        '2': 'Mix 1 teaspoon of salt with 1 teaspoon of baking powder per pound of chicken. Toss the dried chicken wings in this mixture until evenly coated. Place the wings on a rack set over a sheet pan and refrigerate for at least one hour.',
